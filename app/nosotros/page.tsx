    ...
    <main className="flex min-h-screen flex-col bg-slate-50 text-zinc-900 dark:bg-zinc-950 dark:text-zinc-100">
      <div className="mx-auto w-full max-w-5xl flex-1 px-4 py-10 sm:px-6 sm:py-16">
        ...
        <section className="text-center">
          <Badge className="mb-6 border border-emerald-200 bg-emerald-50 text-emerald-800 hover:bg-emerald-100 dark:border-emerald-700/70 dark:bg-emerald-900/30 dark:text-emerald-100 dark:hover:bg-emerald-900/45">
            Hecho en Catamarca
          </Badge>
          ...
          <p className="mx-auto mt-5 max-w-2xl text-base text-zinc-600 dark:text-zinc-300 sm:text-lg">
        ...
        {/* ── Misión ─────────────────────────────────────────────────── */}
        <section className="mt-20 rounded-2xl border border-zinc-100 bg-white px-6 py-10 text-center shadow-sm dark:border-zinc-800 dark:bg-zinc-900 sm:px-12 sm:py-14">
          <h2 className="text-xs font-semibold uppercase tracking-widest text-emerald-700">
            Nuestra misión
          </h2>
          <p className="mx-auto mt-4 max-w-2xl text-xl font-semibold leading-relaxed text-zinc-900 dark:text-zinc-100 sm:text-2xl">
            Digitalizar la economía local y democratizar el acceso a la información comercial
          </p>
          <p className="mx-auto mt-4 max-w-xl text-sm text-zinc-600 dark:text-zinc-300 sm:text-base">
        ...
        <section className="mt-20">
          <div className="text-center">
            ...
            <p className="mx-auto mt-3 max-w-xl text-xl font-semibold text-zinc-900 dark:text-zinc-100 sm:text-2xl">
              Estrategia basada en datos, no en suposiciones
            </p>
          </div>

          <div className="mt-10 grid gap-6 sm:grid-cols-3">
            <div className="rounded-2xl border border-zinc-100 bg-white px-6 py-8 text-center shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
              <div className="mx-auto mb-4 flex size-12 items-center justify-center rounded-full bg-emerald-50 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-200">
                <BarChart3 className="size-6" />
              </div>
              <h3 className="text-base font-semibold text-zinc-900 dark:text-zinc-100">Análisis riguroso</h3>
            ...
            <div className="rounded-2xl border border-zinc-100 bg-white px-6 py-8 text-center shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
              ...
              <h3 className="text-base font-semibold text-zinc-900 dark:text-zinc-100">Liderazgo académico</h3>
              <p className="mt-2 text-sm leading-relaxed text-zinc-600 dark:text-zinc-300">
            ...
            <div className="rounded-2xl border border-zinc-100 bg-white px-6 py-8 text-center shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
              ...
              <h3 className="text-base font-semibold text-zinc-900 dark:text-zinc-100">Diseño centrado en el usuario</h3>
              <p className="mt-2 text-sm leading-relaxed text-zinc-600 dark:text-zinc-300">
        ...
        <section className="mt-20">
          <div className="text-center">
            ...
            <p className="mx-auto mt-3 max-w-md text-xl font-semibold text-zinc-900 dark:text-zinc-100 sm:text-2xl">
          ...
          <div className="mt-10 grid gap-6 sm:grid-cols-3">
            {VALUES.map(({ icon: Icon, title, description }) => (
              <div
                key={title}
                className="rounded-2xl border border-zinc-100 bg-white px-6 py-8 text-center shadow-sm dark:border-zinc-800 dark:bg-zinc-900"
              >
                <div className="mx-auto mb-4 flex size-12 items-center justify-center rounded-full bg-emerald-50 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-200">
